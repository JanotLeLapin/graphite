...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "graphite" is the name you will use in your source code to
                // import this module (e.g. `@import("graphite")`). The name is
    ...
    const protocol_mod_tests = b.addTest(.{
        .root_module = protocol_mod,
    });

    const run_common_mod_tests = b.addRunArtifact(common_mod_tests);
    const run_protocol_mod_tests = b.addRunArtifact(protocol_mod_tests);
    ...
    test_step.dependOn(&run_protocol_mod_tests.step);
