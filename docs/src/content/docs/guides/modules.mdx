...
A hook function may also take a specific structure that contains data regarding
the triggered event.
You may look up the [sources](https://github.com/JanotLeLapin/graphite/blob/main/common/src/hook.zig)
to find more info on each struct.
